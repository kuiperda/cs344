...
problem = {
    ...
    "start2": ["space on table", "b on table", "space on b", "a on table", "c on a", "space on c"],
    "finish2": ["b on table", "space on b", "a on table", "space on a", "c on table", "space on c"],

    "start3": ["a on table", "space on a", "b on table", "space on b", "c on table", "space on c"],
    "finish3": ["c on table", "b on c", "a on b", "space on a", "space on table"],
...
def main():
    ...
    print('\nlab2_B')
    start = problem['start3']
    finish = problem['finish3']
    ops = problem['ops']
    actionSequence = gps(start, finish, ops)
    if actionSequence is None:
        print("plan failure...")
