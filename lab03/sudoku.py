...
#AC3(puzzle)
backtracking_search(puzzle, select_unassigned_variable=mrv, inference=forward_checking) # Consider adding: select_unassigned_variable=mrv & inference=forward_checking
